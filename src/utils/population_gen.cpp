...
double populationGenerator::normalize_value(double value, int sample_index)
{
    ...
    else if (sample_index < min_domain.size())
    {
        ...
        else if (value >= max_domain.at(sample_index))
        {
    ...
    else
    {
        ...
        else if (value >= setValues.at(setValue_index).at(setValues.at(setValue_index).size() - 1)) ///if greater than the last element in the set
        {
    ...
    for (unsigned int j = 0 ; j < popsize; j++)
        for (unsigned int i = 0 ; i < dimensions; i++)
        {
            ...
            if (i  < min_domain.size())
            {
                ...
                else if (par[par_index] >= max_domain.at(i))
                {
            ...
            else if ((i - min_domain.size()) < setValues.size())
            {
                //this is a set value
                ...
                else if (par[par_index] >= setValues.at(setValue_index).at(setValues.at(setValue_index).size() - 1)) ///if greater than the last element in the set
                {
