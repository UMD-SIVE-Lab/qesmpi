...
set(SFML_REQUESTED_VERSION 1.6)
...
#IF(APPLE)
    # debug library
    find_library(SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY_DEBUG lib/x86_64/linux
                 NAMES ${FIND_SFML_COMPONENT_NAME}-d
                 PATH_SUFFIXES lib64 lib
                 PATHS ${FIND_SFML_LIB_PATHS})

    # release library
    find_library(SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY_RELEASE lib/x86_64/linux
...
IF(APPLE)
ELSE()
set( SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY_RELEASE "${SFML_ROOT}/lib/x86_64/linux/libsfml-${FIND_SFML_COMPONENT_LOWER}.so.1.6" )
ENDIF()
